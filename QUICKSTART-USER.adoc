...
// Replace iseriser, Iseriser — See README.adoc for details., just run, Iseriser started successfully. with actuals
= iseriser — Quick Start for Users
:toc:
:toclevels: 2

== What is iseriser?

Iseriser — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./iseriser-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/iseriser/wiki
