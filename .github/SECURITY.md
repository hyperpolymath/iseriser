...
Replace all {{PLACEHOLDER}} values with your information:
  What is the -iser Pattern?     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  iseriser             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/iseriser/security/advisories/new)
...
- This repository (`hyperpolymath/iseriser`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/iseriser/security/advisories)
...
When using What is the -iser Pattern?, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/iseriser/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/iseriser/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/iseriser/discussions) |
...
*Thank you for helping keep What is the -iser Pattern? and its users safe.* 🛡️
